...
<!-- ЗАГОЛОВОК НАД БЕЖЕВЫМИ БЛОКАМИ -->
<h1 class="main-title">Итальянская кухня</h1>
...
<div class="menu-container">
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Неаполитанская_пицца" target="_blank" rel="noopener noreferrer">Неополитанская пицца</a></h3>
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Пепперони" target="_blank" rel="noopener noreferrer">Пицца пепперони</a></h3>
...
<div class="menu-container">
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Карбонара" target="_blank" rel="noopener noreferrer">Паста карбонара</a></h3>
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Болоньезе" target="_blank" rel="noopener noreferrer">Паста болоньезе</a></h3>
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Песто" target="_blank" rel="noopener noreferrer">Паста песто</a></h3>
...
<div class="menu-container">
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Тирамису" target="_blank" rel="noopener noreferrer">Тирамису</a></h3>
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Панна-котта" target="_blank" rel="noopener noreferrer">Панна-котта</a></h3>
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Джелато" target="_blank" rel="noopener noreferrer">Джелато</a></h3>
    ...
    <div class="menu-item">
        <div class="menu-item-content">
            <div class="menu-item-text">
                <h3><a href="https://ru.wikipedia.org/wiki/Кассата" target="_blank" rel="noopener noreferrer">Кассата</a></h3>
    ...
    <!-- Подвал внутри последней карточки -->
